...
import kultklient.legacy.client.utils.player.ArmorUtils;
...
/*/----------------------------------------------------------------------------------------------------------------/*/
/*/ Used from Orion Meteor Addon and edited by KultKollektive                                                           /*/
...
public class Nametags extends Module {
    ...
    private void renderNametagPlayer(PlayerEntity player) {
        ...
        boolean showDev = KultKlientLegacy.getDeveloperUUIDs().contains(player.getUuidAsString());
