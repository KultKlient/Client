...
import kultklient.legacy.client.gui.screens.server.ProtocolScreen;
import kultklient.legacy.client.gui.screens.settings.*;
import kultklient.legacy.client.systems.modules.misc.NameProtect;
import kultklient.legacy.client.systems.modules.render.search.SBlockDataScreen;
import kultklient.legacy.client.utils.Utils;
import kultklient.legacy.client.utils.Version;
import kultklient.legacy.client.gui.screens.*;
import kultklient.legacy.client.gui.screens.accounts.*;
import kultklient.legacy.client.gui.screens.clickgui.*;
import kultklient.legacy.client.gui.screens.server.servermanager.*;
...
public class DiscordRPC extends Module {
    ...
    public DiscordRPC() {
        super(Categories.Client, Items.COMMAND_BLOCK, "discord-rpc", "Shows KultKlient Legacy as your Discord status.");
    ...
    public void onActivate() {
        KultKlientLegacy.LOG.info(KultKlientLegacy.logPrefix + "Enabling Discord Rich Presence...");
        ...
        rpc.largeImageText = "KultKlient Legacy " + Version.getStylized() + " - " + mc.getVersionType() + " " + Version.getMinecraft();
        applySmallImage();
        ...
        KultKlientLegacy.LOG.info(KultKlientLegacy.logPrefix + "Discord Rich Presence enabled!");
        new Thread(() -> {
    ...
    public void onDeactivate() {
        KultKlientLegacy.LOG.info(KultKlientLegacy.logPrefix + "Disabling Discord Rich Presence...");
        net.arikia.dev.drpc.DiscordRPC.discordClearPresence();
        net.arikia.dev.drpc.DiscordRPC.discordShutdown();
        KultKlientLegacy.LOG.info(KultKlientLegacy.logPrefix + "Discord Rich Presence disabled!");
    }
