...
import kultklient.legacy.client.events.kultklientlegacy.ActiveModulesChangedEvent;
...
import kultklient.legacy.client.systems.modules.chat.*;
import kultklient.legacy.client.systems.modules.client.*;
import kultklient.legacy.client.systems.modules.combat.*;
import kultklient.legacy.client.systems.modules.crash.*;
import kultklient.legacy.client.systems.modules.misc.*;
import kultklient.legacy.client.systems.modules.client.swarm.Swarm;
import kultklient.legacy.client.systems.modules.movement.*;
import kultklient.legacy.client.systems.modules.movement.elytrafly.ElytraFly;
import kultklient.legacy.client.systems.modules.movement.speed.Speed;
import kultklient.legacy.client.systems.modules.player.*;
...
import kultklient.legacy.client.systems.modules.render.search.Search;
import kultklient.legacy.client.systems.modules.world.*;
import kultklient.legacy.client.systems.modules.world.Timer;
import kultklient.legacy.client.utils.Utils;
import kultklient.legacy.client.utils.misc.ValueComparableMap;
...
public class Modules extends System<Modules> {
    ...
    void addActive(Module module) {
        synchronized (active) {
            if (!active.contains(module)) {
                active.add(module);
                KultKlientLegacy.EVENT_BUS.post(ActiveModulesChangedEvent.get());
            }
        }
    }
    ...
    void removeActive(Module module) {
        synchronized (active) {
            if (active.remove(module)) KultKlientLegacy.EVENT_BUS.post(ActiveModulesChangedEvent.get());
        }
    }
    ...
    private boolean onBinding(boolean isKey, int value) {
        if (moduleToBind != null && moduleToBind.keybind.canBindTo(isKey, value)) {
            ...
            KultKlientLegacy.EVENT_BUS.post(ModuleBindChangedEvent.get(moduleToBind));
            moduleToBind = null;
            return true;
        }
        ...
        synchronized (active) {
            for (Module module : modules) {
                if (module.isActive() && !module.runInMainMenu) {
                    KultKlientLegacy.EVENT_BUS.subscribe(module);
                    module.onActivate();
                }
            }
        }
    ...
    private void onGameLeft(GameLeftEvent event) {
        synchronized (active) {
            for (Module module : modules) {
                if (module.isActive() && !module.runInMainMenu) {
                    KultKlientLegacy.EVENT_BUS.unsubscribe(module);
                    module.onDeactivate();
                }
            }
        }
    ...
    public static class ModuleRegistry extends Registry<Module> {
        public ModuleRegistry() {
            super(RegistryKey.ofRegistry(new Identifier("kultklientlegacy", "modules")), Lifecycle.stable());
        }
