...
import kultklient.legacy.client.systems.modules.movement.elytrafly.modes.Packet;
import kultklient.legacy.client.systems.modules.movement.elytrafly.modes.Pitch40;
import kultklient.legacy.client.systems.modules.movement.elytrafly.modes.Vanilla;
import kultklient.legacy.client.systems.modules.Categories;
import kultklient.legacy.client.systems.modules.Module;
import kultklient.legacy.client.systems.modules.Modules;
import kultklient.legacy.client.systems.modules.player.ChestSwap;
...
public class ElytraFly extends Module {
    ...
    protected void enableGroundListener() {
        KultKlientLegacy.EVENT_BUS.subscribe(staticGroundListener);
    }

    protected void disableGroundListener() {
        KultKlientLegacy.EVENT_BUS.unsubscribe(staticGroundListener);
    }
    ...
    protected void enableInstaDropListener() {
        KultKlientLegacy.EVENT_BUS.subscribe(staticInstadropListener);
    }

    protected void disableInstaDropListener() {
        KultKlientLegacy.EVENT_BUS.unsubscribe(staticInstadropListener);
    }
