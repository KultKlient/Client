...
import kult.legacy.klient.systems.modules.player.AutoEat;
import kult.legacy.klient.systems.modules.player.AutoTool;
import kult.legacy.klient.utils.misc.HorizontalDirection;
import kult.legacy.klient.utils.misc.MBlockPos;
import kult.legacy.klient.utils.player.CustomPlayerInput;
...
public class HighwayBuilder extends Module {
    ...
    private final Setting<SettingColor> renderMineSideColor = sgRenderMine.add(new ColorSetting.Builder()
        ...
        .defaultValue(new SettingColor(KultKlientLegacy.INSTANCE.KULTKLIENT_COLOR.r, KultKlientLegacy.INSTANCE.KULTKLIENT_COLOR.g, KultKlientLegacy.INSTANCE.KULTKLIENT_COLOR.b, 150))
        .build()
    );
