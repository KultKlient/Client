...
import kultklient.legacy.client.systems.modules.player.AutoEat;
import kultklient.legacy.client.systems.modules.player.AutoTool;
import kultklient.legacy.client.utils.misc.HorizontalDirection;
import kultklient.legacy.client.utils.misc.MBlockPos;
import kultklient.legacy.client.utils.player.CustomPlayerInput;
...
public class HighwayBuilder extends Module {
    ...
    private final Setting<SettingColor> renderMineSideColor = sgRenderMine.add(new ColorSetting.Builder()
        ...
        .defaultValue(new SettingColor(KultKlientLegacy.INSTANCE.MATHAX_COLOR.r, KultKlientLegacy.INSTANCE.MATHAX_COLOR.g, KultKlientLegacy.INSTANCE.MATHAX_COLOR.b, 150))
        .build()
    );
