...
import kultklient.legacy.client.utils.network.serverfinder.IPAddress;
import kultklient.legacy.client.utils.network.serverfinder.IServerFinderDoneListener;
import kultklient.legacy.client.utils.network.serverfinder.MServerInfo;
import kultklient.legacy.client.utils.network.serverfinder.ServerPinger;
...
public class ServerFinderScreen extends WindowScreen implements IServerFinderDoneListener {
    ...
    private void saveToFile() {
        ...
        Path filePath = KultKlientLegacy.GAME_FOLDER.toPath().resolve("servers.txt");
        ...
        KultKlientLegacy.LOG.info(KultKlientLegacy.logPrefix + "Saved " + newIPs + " new IP" + (newIPs == 1 ? "" : "s"));
    }
