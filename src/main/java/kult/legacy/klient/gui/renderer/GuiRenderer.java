...
public class GuiRenderer {
    ...
    public static void init() {
        CIRCLE = addTexture(new Identifier("kultklientlegacy", "textures/icons/gui/circle.png"));
        TRIANGLE = addTexture(new Identifier("kultklientlegacy", "textures/icons/gui/triangle.png"));
        EDIT = addTexture(new Identifier("kultklientlegacy", "textures/icons/gui/edit.png"));
        RESET = addTexture(new Identifier("kultklientlegacy", "textures/icons/gui/reset.png"));
