...
public class ContainerTooltipComponent implements TooltipComponent, KultKlientTooltipData {
    private static final Identifier TEXTURE_CONTAINER_BACKGROUND = new Identifier("kultklientlegacy", "textures/container/container.png");
