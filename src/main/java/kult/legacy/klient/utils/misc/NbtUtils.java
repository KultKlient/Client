...
public class NbtUtils {
    ...
    public static boolean toClipboard(String name, NbtCompound nbtCompound) {
        ...
        try {
            ...
            KultKlientLegacy.LOG.error(KultKlientLegacy.logPrefix + String.format("Error copying %s NBT to clipboard!", name));
    ...
    public static NbtCompound fromClipboard(NbtCompound schema) {
        try {
            ...
            KultKlientLegacy.LOG.error(KultKlientLegacy.logPrefix + "Invalid NBT data pasted!");
