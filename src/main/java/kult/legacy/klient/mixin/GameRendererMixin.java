...
import kult.legacy.klient.events.render.RenderAfterWorldEvent;
import kult.legacy.klient.mixininterface.IVec3d;
import kult.legacy.klient.renderer.Renderer3D;
import kult.legacy.klient.systems.modules.player.LiquidInteract;
import kult.legacy.klient.systems.modules.player.NoMiningTrace;
...
public abstract class GameRendererMixin {
    ...
    private void onRenderWorld(float tickDelta, long limitTime, MatrixStack matrices, CallbackInfo info, boolean bl, Camera camera, MatrixStack matrixStack, double d, float f, Matrix4f matrix4f) {
        ...
        client.getProfiler().push("kultklientlegacy_render");
    ...
    private void onRenderWorldTail(CallbackInfo info) {
        KultKlientLegacy.EVENT_BUS.post(RenderAfterWorldEvent.get());
    }
