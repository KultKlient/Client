...
import kult.klient.utils.player.ArmorUtils;
...
public class Nametags extends Module {
    private static final Identifier KULTKLIENT_ICON = new Identifier("kultklient", "textures/icons/icon.png");
    ...
    private void renderNametagPlayer(PlayerEntity player) {
        ...
        boolean showDev = KultKlient.getDeveloperUUIDs().contains(player.getUuidAsString());
