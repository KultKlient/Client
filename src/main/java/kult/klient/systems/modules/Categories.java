...
public class Categories {
    ...
    public static final Category Client = new Category("Client", Items.COMMAND_BLOCK, Color.fromRGBA(KultKlient.INSTANCE.KULTKLIENT_COLOR.r, KultKlient.INSTANCE.KULTKLIENT_COLOR.g, KultKlient.INSTANCE.KULTKLIENT_COLOR.b, 255));
