...
public class TNTAura extends Module {
    ...
    private final Setting<SettingColor> obsidianSideColor = sgObsidianRender.add(new ColorSetting.Builder()
        ...
        .defaultValue(new SettingColor(KultKlient.INSTANCE.KULTKLIENT_COLOR.r, KultKlient.INSTANCE.KULTKLIENT_COLOR.g, KultKlient.INSTANCE.KULTKLIENT_COLOR.b, 70))
        .build()
    );
    ...
    private final Setting<SettingColor> obsidianNextSideColor = sgObsidianRender.add(new ColorSetting.Builder()
        ...
        .defaultValue(new SettingColor(KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.r, KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.g, KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.b, 75))
        .build()
    );
