...
import kult.klient.systems.modules.movement.elytrafly.modes.Packet;
import kult.klient.systems.modules.movement.elytrafly.modes.Pitch40;
import kult.klient.systems.modules.movement.elytrafly.modes.Vanilla;
import kult.klient.systems.modules.player.ChestSwap;
...
public class ElytraFly extends Module {
    ...
    protected void enableGroundListener() {
        KultKlient.EVENT_BUS.subscribe(staticGroundListener);
    }

    protected void disableGroundListener() {
        KultKlient.EVENT_BUS.unsubscribe(staticGroundListener);
    }
    ...
    protected void enableInstaDropListener() {
        KultKlient.EVENT_BUS.subscribe(staticInstadropListener);
    }

    protected void disableInstaDropListener() {
        KultKlient.EVENT_BUS.unsubscribe(staticInstadropListener);
    }
