...
import kult.klient.mixin.CreativeInventoryScreenAccessor;
import kult.klient.mixin.KeyBindingAccessor;
...
public class GUIMove extends Module {
    ...
    private void set(KeyBinding bind, boolean pressed) {
        ...
        if (wasPressed != pressed && key.getCategory() == InputUtil.Type.KEYSYM) KultKlient.EVENT_BUS.post(KeyEvent.get(key.getCode(), 0, pressed ? KeyAction.Press : KeyAction.Release));
    }
