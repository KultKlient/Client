...
public class PacketFly extends Module {
    ...
    public void onDeactivate() {
        ...
        Modules.get().get(kult.klient.systems.modules.world.Timer.class).setOverride(kult.klient.systems.modules.world.Timer.OFF);
    }
    ...
    public void onPreTick(TickEvent.Pre event) {
        if (boost.get()) Modules.get().get(kult.klient.systems.modules.world.Timer.class).setOverride(boostTimer.get().floatValue());
        else Modules.get().get(kult.klient.systems.modules.world.Timer.class).setOverride(kult.klient.systems.modules.world.Timer.OFF);
