...
import kult.klient.systems.modules.player.AutoEat;
import kult.klient.systems.modules.player.AutoTool;
import kult.klient.utils.misc.HorizontalDirection;
import kult.klient.utils.misc.MBlockPos;
import kult.klient.utils.player.CustomPlayerInput;
...
import kult.klient.utils.world.Dir;
...
public class HighwayBuilder extends Module {
    ...
    private final Setting<SettingColor> renderMineSideColor = sgRenderMine.add(new ColorSetting.Builder()
        ...
        .defaultValue(new SettingColor(KultKlient.INSTANCE.KULTKLIENT_COLOR.r, KultKlient.INSTANCE.KULTKLIENT_COLOR.g, KultKlient.INSTANCE.KULTKLIENT_COLOR.b, 150))
        .build()
    );
