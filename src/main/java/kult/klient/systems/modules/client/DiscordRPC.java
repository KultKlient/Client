...
import kult.klient.gui.screens.accounts.AddAlteningAccountScreen;
import kult.klient.gui.screens.accounts.AddCrackedAccountScreen;
import kult.klient.gui.screens.accounts.AddPremiumAccountScreen;
...
import kult.klient.gui.screens.server.ProtocolScreen;
import kult.klient.gui.screens.server.servermanager.*;
import kult.klient.gui.screens.settings.*;
import kult.klient.gui.tabs.builtin.*;
import kult.klient.mixin.MinecraftServerAccessor;
...
import kult.klient.systems.modules.render.search.SBlockDataScreen;
import kult.klient.utils.Utils;
import kult.klient.utils.Version;
import kult.klient.utils.misc.LastServerInfo;
import kult.klient.utils.render.PeekScreen;
...
public class DiscordRPC extends Module {
    ...
    public final Setting<SmallImageMode> smallImageMode = sgGeneral.add(new EnumSetting.Builder<SmallImageMode>()
        .name("small-images")
        .description("Shows cats or dogs on KultKlient rpc.")
        .defaultValue(SmallImageMode.Cats)
        .build()
    );

    public DiscordRPC() {
        super(Categories.Client, Items.COMMAND_BLOCK, "discord-rpc", "Shows KultKlient as your Discord status.", true);
    }

    @Override
    public void onActivate() {
        KultKlient.LOG.info(KultKlient.logPrefix + "Enabling Discord Rich Presence...");
        ...
        rpc.largeImageText = "KultKlient " + Version.getStylized() + " - " + mc.getVersionType() + " " + Version.getMinecraft();
        applySmallImage();
        ...
        KultKlient.LOG.info(KultKlient.logPrefix + "Discord Rich Presence enabled!");
    ...
    public void onDeactivate() {
        KultKlient.LOG.info(KultKlient.logPrefix + "Disabling Discord Rich Presence...");
        net.arikia.dev.drpc.DiscordRPC.discordClearPresence();
        net.arikia.dev.drpc.DiscordRPC.discordShutdown();
        KultKlient.LOG.info(KultKlient.logPrefix + "Discord Rich Presence disabled!");
    }
