...
import kult.klient.utils.base91.Base91;
...
public class ChatEncryption extends Module {
    private static final String password = "KultKlientEncryption";
    ...
    private final Setting<String> groupKey = sgGeneral.add(new StringSetting.Builder()
        ...
        .defaultValue("KultKlientEncryption")
    ...
    private void onMessageReceive(ReceiveMessageEvent event) {
        ...
        if (message.getString().endsWith(suffix.get()) && !suffix.get().isEmpty()) {
            ...
            try {
                ...
                prefix.setStyle(prefix.getStyle().withColor(KultKlient.INSTANCE.KULTKLIENT_COLOR.getPacked()));
