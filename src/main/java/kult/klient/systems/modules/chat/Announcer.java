...
import kult.klient.events.entity.player.BreakBlockEvent;
...
public class Announcer extends Module {
    ...
    public void onActivate() {
        for (Feature feature : features) {
            if (feature.isEnabled()) {
                KultKlient.EVENT_BUS.subscribe(feature);
                feature.reset();
            }
        }
    }
    ...
    public void onDeactivate() {
        for (Feature feature : features) {
            if (feature.isEnabled()) KultKlient.EVENT_BUS.unsubscribe(feature);
        }
    }
    ...
    private class Moving extends Feature {
        ...
        .defaultValue("I just moved %distance% blocks thanks to KultKlient!")
        .build()
        );
    ...
    private class Mining extends Feature {
        ...
        private final Setting<String> message = sg.add(new StringSetting.Builder()
            ...
            .defaultValue("I just mined %count% %block% thanks to KultKlient!")
            .build()
        );
    ...
    private class Placing extends Feature {
        ...
        private final Setting<String> message = sg.add(new StringSetting.Builder()
            ...
            .defaultValue("I just placed %count% %block% thanks to KultKlient!")
            .build()
        );
    ...
    private class DropItems extends Feature {
        ...
        private final Setting<String> message = sg.add(new StringSetting.Builder()
            ...
            .defaultValue("I just dropped %count% %item% thanks to KultKlient!")
            .build()
        );
    ...
    private class PickItems extends Feature {
        ...
        private final Setting<String> message = sg.add(new StringSetting.Builder()
            ...
            .defaultValue("I just picked up %count% %item% thanks to KultKlient!")
            .build()
        );
    ...
    private class OpenContainer extends Feature {
        private final Setting<String> message = sg.add(new StringSetting.Builder()
            ...
            .defaultValue("I just opened %name% thanks to KultKlient!")
            .build()
        );
