package kult.klient.systems.waypoints;
...
import kult.klient.utils.files.StreamUtils;
...
public class Waypoints extends System<Waypoints> implements Iterable<Waypoint> {
    ...
    @Override
    public void init() {
        File iconsFolder = new File(KultKlient.FOLDER, "WayPoint-Icons");
        iconsFolder.mkdirs();
    ...
    public File getFile() {
        ...
        return new File(new File(KultKlient.VERSION_FOLDER, "WayPoints"), Utils.getWorldName() + ".nbt");
    }
    ...
    private void copyIcon(File file) {
        StreamUtils.copy(Waypoints.class.getResourceAsStream("/assets/kultklient/textures/icons/waypoints/" + file.getName()), file);
    }
}
