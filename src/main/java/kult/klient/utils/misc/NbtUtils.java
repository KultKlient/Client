...
public class NbtUtils {
    ...
    public static boolean toClipboard(String name, NbtCompound nbtCompound) {
        ...
        try {
            ...
            KultKlient.LOG.error(KultKlient.logPrefix + String.format("Error copying %s NBT to clipboard!", name));
    ...
    public static NbtCompound fromClipboard(NbtCompound schema) {
        try {
            ...
            KultKlient.LOG.error(KultKlient.logPrefix + "Invalid NBT data pasted!");
