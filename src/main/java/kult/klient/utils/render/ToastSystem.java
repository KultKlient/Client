...
public class ToastSystem implements Toast {
    public static final int TITLE_COLOR = Color.fromRGBA(KultKlient.INSTANCE.KULTKLIENT_COLOR.r, KultKlient.INSTANCE.KULTKLIENT_COLOR.g, KultKlient.INSTANCE.KULTKLIENT_COLOR.b, 255);
