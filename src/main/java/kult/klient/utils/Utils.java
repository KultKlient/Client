...
import kult.klient.utils.world.BlockEntityIterator;
import kult.klient.utils.world.ChunkIterator;
import kult.klient.utils.world.Dimension;
import kult.klient.KultKlient;
import kult.klient.mixin.ClientPlayNetworkHandlerAccessor;
import kult.klient.mixin.MinecraftClientAccessor;
import kult.klient.mixin.MinecraftServerAccessor;
import kult.klient.systems.modules.render.BetterTooltips;
...
public class Utils {
    ...
    public static void init() {
        KultKlient.EVENT_BUS.subscribe(Utils.class);
    }
    ...
    public static boolean isDeveloper(String uuid) {
        uuid = uuid.replace("-", "");
        return KultKlient.getDeveloperUUIDs().contains(uuid);
    }
