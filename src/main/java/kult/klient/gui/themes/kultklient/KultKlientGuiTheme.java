...
import kult.klient.gui.themes.kultklient.widgets.*;
import kult.klient.gui.themes.kultklient.widgets.pressable.*;
...
import kult.klient.gui.DefaultSettingsWidgetFactory;
import kult.klient.gui.GuiTheme;
import kult.klient.gui.WidgetScreen;
import kult.klient.gui.themes.kultklient.widgets.input.WKultKlientDropdown;
import kult.klient.gui.themes.kultklient.widgets.input.WKultKlientSlider;
import kult.klient.gui.themes.kultklient.widgets.input.WKultKlientTextBox;
...
public class KultKlientGuiTheme extends GuiTheme {
    ...
    public final Setting<SettingColor> mainColor = color("main", "Main color of the GUI.", new SettingColor(KultKlient.INSTANCE.KULTKLIENT_COLOR.r, KultKlient.INSTANCE.KULTKLIENT_COLOR.g, KultKlient.INSTANCE.KULTKLIENT_COLOR.b));
    public final Setting<SettingColor> checkboxColor = color("checkbox", "Color of checkbox.", new SettingColor(KultKlient.INSTANCE.KULTKLIENT_COLOR.r, KultKlient.INSTANCE.KULTKLIENT_COLOR.g, KultKlient.INSTANCE.KULTKLIENT_COLOR.b));
    ...
    public final Setting<SettingColor> textHighlightColor = color(sgTextColors, "text-highlight", "Color of text highlighting.", new SettingColor(KultKlient.INSTANCE.KULTKLIENT_COLOR.r, KultKlient.INSTANCE.KULTKLIENT_COLOR.g, KultKlient.INSTANCE.KULTKLIENT_COLOR.b));
    ...
    public final ThreeStateColorSetting backgroundColor = new ThreeStateColorSetting(
            sgBackgroundColors,
            "background",
            new SettingColor(KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.r, KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.g, KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.b, 100),
            new SettingColor(KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.r, KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.g, KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.b, 135),
            new SettingColor(KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.r, KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.g, KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.b, 175)
    );

    public final Setting<SettingColor> moduleBackground = color(sgBackgroundColors, "module-background", "Color of module background when active.", new SettingColor(KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.r, KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.g, KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.b, 200));
    ...
    public final ThreeStateColorSetting scrollbarColor = new ThreeStateColorSetting(
        ...
        "Scrollbar",
        new SettingColor(KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.r, KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.g, KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.b, 100),
        new SettingColor(KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.r, KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.g, KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.b, 150),
        new SettingColor(KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.r, KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.g, KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.b, 150)
    );
    ...
    public final Setting<SettingColor> sliderLeft = color(sgSlider, "slider-left", "Color of slider left part.", new SettingColor(KultKlient.INSTANCE.KULTKLIENT_COLOR.r, KultKlient.INSTANCE.KULTKLIENT_COLOR.g, KultKlient.INSTANCE.KULTKLIENT_COLOR.b));
    public final Setting<SettingColor> sliderRight = color(sgSlider, "slider-right", "Color of slider right part.", new SettingColor(KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.r, KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.g, KultKlient.INSTANCE.KULTKLIENT_BACKGROUND_COLOR.b));
