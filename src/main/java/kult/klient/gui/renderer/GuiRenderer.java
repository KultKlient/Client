package kult.klient.gui.renderer;

import kult.klient.gui.renderer.operations.TextOperation;
import kult.klient.gui.renderer.packer.GuiTexture;
import kult.klient.gui.renderer.packer.TexturePacker;
import kult.klient.utils.misc.Pool;
import kult.klient.utils.render.ByteTexture;
...
import static kult.klient.utils.Utils.*;
...
public class GuiRenderer {
    ...
    public static void init() {
        CIRCLE = addTexture(new Identifier("kultklient", "textures/icons/gui/circle.png"));
        TRIANGLE = addTexture(new Identifier("kultklient", "textures/icons/gui/triangle.png"));
        EDIT = addTexture(new Identifier("kultklient", "textures/icons/gui/edit.png"));
        RESET = addTexture(new Identifier("kultklient", "textures/icons/gui/reset.png"));
