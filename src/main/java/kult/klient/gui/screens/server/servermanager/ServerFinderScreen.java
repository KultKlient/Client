package kult.klient.gui.screens.server.servermanager;
...
import kult.klient.mixininterface.IMultiplayerScreen;
import kult.klient.utils.network.serverfinder.IPAddress;
import kult.klient.utils.network.serverfinder.IServerFinderDoneListener;
import kult.klient.utils.network.serverfinder.MServerInfo;
import kult.klient.utils.network.serverfinder.ServerPinger;
...
public class ServerFinderScreen extends WindowScreen implements IServerFinderDoneListener {
    ...
    private void saveToFile() {
        ...
        Path filePath = KultKlient.GAME_FOLDER.toPath().resolve("servers.txt");
        ...
        KultKlient.LOG.info(KultKlient.logPrefix + "Saved " + newIPs + " new IP" + (newIPs == 1 ? "" : "s"));
    }
