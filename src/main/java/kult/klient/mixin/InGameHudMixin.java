...
import kult.klient.systems.modules.render.MountHUD;
...
public abstract class InGameHudMixin {
    ...
    private void onRender(MatrixStack matrixStack, float tickDelta, CallbackInfo info) {
        client.getProfiler().push("kultklient_render_2d");

        Utils.unscaledProjection();

        KultKlient.EVENT_BUS.post(Render2DEvent.get(scaledWidth, scaledHeight, tickDelta));
