...
import kult.klient.renderer.Renderer3D;
...
import kult.klient.systems.modules.player.LiquidInteract;
import kult.klient.systems.modules.player.NoMiningTrace;
import kult.klient.systems.modules.player.Reach;
import kult.klient.systems.modules.render.Freecam;
import kult.klient.systems.modules.render.NoBob;
...
public abstract class GameRendererMixin {
    ...
    private void onRenderWorld(float tickDelta, long limitTime, MatrixStack matrices, CallbackInfo info, boolean bl, Camera camera, MatrixStack matrixStack, double d, float f, Matrix4f matrix4f) {
        ...
        client.getProfiler().push("kultklient_render");
    ...
    private void onRenderWorldTail(CallbackInfo info) {
        KultKlient.EVENT_BUS.post(RenderAfterWorldEvent.get());
    }
